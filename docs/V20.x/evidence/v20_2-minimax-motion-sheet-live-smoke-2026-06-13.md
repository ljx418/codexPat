...
| --- | --- | --- |
| real local cat photo sample exists | passed | sampleCount=1; sampleId=sample_1 |
| sample size is limited | passed | less than 3 real cat photos available; low-retry reliability claim is forbidden |
...
| MiniMax live output received | passed | ok=true; imageCount=1; reasonCode=provider_capability_confirmed |
...
| benchmark low-retry reliability not claimed | passed | sampleCount=1; acceptedSampleCount=1 |
| one-sample scoped smoke result | passed | status=passed; reasonCode=provider_smoke_passed_sample_limited |
...
| imageCount | 1 |
| safeOutputFileNames | sample_1-minimax-motion-sheet-1.jpeg |
| benchmarkReasonCode | provider_smoke_passed_sample_limited |
