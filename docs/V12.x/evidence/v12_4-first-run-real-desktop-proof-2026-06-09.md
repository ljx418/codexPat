...
| first-run real desktop screenshot captured | passed | docs/V12.x/evidence/screenshots/v12_4-first-run-desktop-2026-06-09.png |
| first-run screenshot visible pixels | passed | {"ok":true,"width":2880,"height":1800,"nonblankRatio":0.6564,"uniqueColorSample":256,"reasonCode":"desktop_visible"} |
...
- first-run desktop screenshot: `docs/V12.x/evidence/screenshots/v12_4-first-run-desktop-2026-06-09.png`
