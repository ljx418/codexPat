...
| V40.3R3 Candidate Source Decision | choose accepted manual/import, materially different direct-runner route, or failed/blocked with V39 fallback | route decision evidence before any more code |
